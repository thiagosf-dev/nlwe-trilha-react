...
export function NoteCard({ note }: NoteCradProps) {
  return (
    <Dialog.Root>
      <Dialog.Trigger
        className={`rounded-md text-left bg-slate-800 p-5 flex flex-col gap-3 overflow-hidden outline-none relative hover:ring-2
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={`fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh]
            bg-slate-700 rounded-md flex flex-col outline-none overflow-hidden`}
        >
